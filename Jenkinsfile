        ...
        stage('Verify Terraform Files') {
            steps {
                script {
                    ...
                    sh 'ls -l'  // ✅ Check if dev.tfvars and other Terraform files exist
                    sh 'cat dev.tfvars || echo "⚠️ WARNING: dev.tfvars NOT FOUND!"'  // ✅ Print dev.tfvars contents
                }
            }
        }
        ...
        stage('Terraform Plan') {
            steps {
                withCredentials([[
                    ...
                    script {
                        echo 'Running Terraform Plan...'
                        terraform plan(directory: '.', varsFile: 'dev.tfvars', planFile: 'tfplan')
                    }
                }
            }
        }
        ...
        stage('Terraform Apply') {
            steps {
                withCredentials([[
                    ...
                    script {
                        echo 'Applying Terraform changes...'
                        terraform apply(directory: '.', planFile: 'tfplan', autoApprove: true)
                    }
                }
            }
        }
